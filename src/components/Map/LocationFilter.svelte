...
<div id="card" style="margin-top:4.5%">
	...
	<div clas="row" style="color:black;display:flex; justfiy-content:center; margin-top:10%">
			...
			<div class="col-sm-6" style="margin-left:2%;">
				...
				<input name="idFilter" style="width:75%; margin-top:3%;display:flex; justify-content:center;align-items:center;"  placeholder="Set Follower ID"   bind:value={followerID} autocomplete="on" />
			</div>
