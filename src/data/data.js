const HEADER = "Geolocation System";

const NAVBAR_DATA = [
  { id: 1, url: "/", label: "Home" },
  { id: 2, url: "#services", label: "About us" },
  { id: 3, url: "#about-us", label: "Register" },
  { id: 4, url: "#testimonials", label: "Login" },
  { id: 5, url: "#footer", label: "Contacts" }
];
const BANNER_DATA = {
  HEADING: "Go & Svelte",
  DECRIPTION:
    "Welcome, this project has the objective to help you dont get in danger by sending your location in a period of time.",
};
const SERVICE_DATA = {
